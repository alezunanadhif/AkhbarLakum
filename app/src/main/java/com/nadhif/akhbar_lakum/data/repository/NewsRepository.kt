package com.nadhif.akhbar_lakum.data.repository

import android.util.Log
import androidx.lifecycle.LiveData
import androidx.lifecycle.MutableLiveData
import com.nadhif.akhbar_lakum.data.model.NewsResponse
import com.nadhif.akhbar_lakum.data.network.ApiClient
import retrofit2.Call
import retrofit2.Callback
import retrofit2.Response

class NewsRepository {
    private val _worldNews = MutableLiveData<NewsResponse>()
    val worldNews: LiveData<NewsResponse> = _worldNews
    ...
    fun getWorldNews() {
        ...
        ApiClient.provideApiService().getWorldNews()
                ...
                override fun onResponse(
                    ...
                    if (response.isSuccessful) {
                        ...
                        if (responseBody != null) {
                            _worldNews.postValue(response.body())
                        }
                    } else {
                        Log.e(
                            "Repository",
